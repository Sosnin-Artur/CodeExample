...
{        
    ...
    public void Init()
    {                
        _gameObject = GameObject.Instantiate(
            Resources.Load(PathsInResources.Player)) as GameObject;
    ...
    public IEnumerator WhenTouchDamager_AndNotDead_ThenCurrentHealthShouldBeLess()
    {
        ...
        var damager = GameObject.Instantiate(
            Resources.Load(PathsInResources.Enemy)) as GameObject;
